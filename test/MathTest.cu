...
int testMatrixCreation() {
    ...
    math::Matrix<double> creationTest2 = math::Matrix<double>::ones(40, 40);
    creationTest2.display();
    std::cout << "Empty Initialization with Assignment 5x30" << std::endl;
    math::Matrix<float> creationTest3 = math::Matrix<float>::sequentialMatrix(5, 30);
    creationTest3.display();
    std::cout << "Empty Initialization with Assignment 15x5" << std::endl;
    math::Matrix<float> creationTest4 = math::Matrix<float>::sequentialMatrix(15, 5);
...
int testMatrixCopy() {
    ...
    math::Matrix<float> copyTest0 = math::Matrix<float>::sequentialMatrix(2, 10);
...
int testMatrixReshape() {
    ...
    math::Matrix<float> reshapeTest0 = math::Matrix<float>::sequentialMatrix(5, 30);
...
int testMatrixTranspose() {
    ...
    math::Matrix<float> transposeTest0 = math::Matrix<float>::sequentialMatrix(5, 30);
...
int testMatrixRandomize() {
    ...
    math::Matrix<float> randomizeTest0 = math::Matrix<float>::sequentialMatrix(5, 30);
    randomizeTest0 = math::Matrix<float>::randomNormalLike(randomizeTest0, 0.0, 1.0);
    randomizeTest0.display();
    std::cout << "Uniform Randomization | Range [0, 1]" << std::endl;
    randomizeTest0 = math::Matrix<float>::randomUniformLike(randomizeTest0, 0.0, 1.0);
    randomizeTest0.display();
    return 0;
}
...
int testRowMean() {
    ...
    math::Matrix<int> rowMeanTest0 = math::Matrix<int>::sequentialMatrix(5, 30);
...
int testDotProduct() {
    ...
    math::Matrix<int> dotTest0 = math::Matrix<int>::ones(30, 5);
    dotTest0.display();
...
int testMatrixMultiplication() {
    ...
    math::Matrix<int> multiplicationTest0 = math::Matrix<int>::ones(10, 5);
    multiplicationTest0.display();
    std::cout << "5x5 Sequential Matrix" << std::endl;
    math::Matrix<int> multiplicationTest1 = math::Matrix<int>::sequentialMatrix(5, 5);
...
int testMatrixArithmetic() {
    ...
    math::Matrix<float> arithmeticTest0 = math::Matrix<float>::ones(10, 10);
    arithmeticTest0.display();
    std::cout << "10x10 Sequential Matrix" << std::endl;
    math::Matrix<float> arithmeticTest1 = math::Matrix<float>::sequentialMatrix(10, 10);
...
int testMatrixVectorArithmetic() {
    ...
    std::cout << "10x10 Ones Matrix" << std::endl;
    math::Matrix<int> vectorArithmeticTest0 = math::Matrix<int>::ones(10, 10);
    vectorArithmeticTest0.display();
    std::cout << "1x10 Sequential Column Vector" << std::endl;
    math::Matrix<int> vectorArithmeticTest1 = math::Matrix<int>::sequentialMatrix(10, 1);
    ...
    math::Matrix<int> vectorArithmeticTest2 = math::Matrix<int>::sequentialMatrix(1, 10);
...
int testMatrixScalarArithmetic() {
    ...
    std::cout << "10x10 Ones Matrix" << std::endl;
    math::Matrix<int> scalarArithmeticTest0 = math::Matrix<int>::ones(10, 10);
...
int testMatrixHadamardProduct() {
    ...
    std::cout << "10x10 Sequential Matrix" << std::endl;
    math::Matrix<int> hadamardProductTest0 = math::Matrix<int>::sequentialMatrix(10, 10);
...
int testMatrixApplyFunction() {
    ...
    std::cout << "10x10 Sequential Matrix" << std::endl;
    math::Matrix<double> applyFunctionTest0 = math::Matrix<double>::sequentialMatrix(10, 10) - 50;
...
int testMatrixPower() {
    ...
    std::cout << "10x10 Sequential Matrix" << std::endl;
    math::Matrix<double> powerTest0 = math::Matrix<double>::sequentialMatrix(10, 10);
    powerTest0.display();
