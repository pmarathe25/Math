...
int main() {
    ...
    math::Matrix<int> mat = math::Matrix<int>(4, 100000); // math::Matrix<int>({{0, 1}, {2, 3}, {4, 5}});
    math::Matrix<int> other = math::Matrix<int>(100000, 4); // math::Matrix<int>({{0, 1, 2}, {3, 4, 5}});
    mat.at(0, 1) = 5;
    // math::display(mat);
    std::cout << std::endl;
    // math::display(other);
    ...
    std::vector<double> a {2, 0}; //, 4, 5, 6, 7, 2, 3, 4, 5, 4, 5, 6};
    std::vector<double> b = {2, 0}; //, 5, 6, 7, 8, 3, 2, 4, 5, 6, 76, 54};
